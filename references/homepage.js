...
<Box>
  ...
  >
    <Box width="30%">
      <List>
        {left_side_of_list.map(item => {
          return(
            <ListItem key={item} m={5}>{item}</ListItem>
          )
        })}
      </List>
    </Box>
    <Box width="30%">
      <List>
      {right_side_of_list.map(item => {
          return(
            <ListItem kdy={item} m={5}>{item}</ListItem>
          )
        })}
      </List>
    </Box>
...
<Box>
  ...
  >
    <Box width="30%">
      <List>
      {benefits_list_left_side.map(item => {
          return(
            <ListItem key={item} m={5}>{item}</ListItem>
          )
        })}
    ...
    <Box width="30%">
      <List>
      {benefits_list_right_side.map(item => {
          return(
            <ListItem key={item} m={5}>{item}</ListItem>
          )
        })}
...
>
  ...
  <CtaForm primary_color={primary_color} button_text={button_text} clientEmail={email} />
